...
//! Both Python Nethra agents and Rust TREDO sub-agents register here.
//!
...
pub enum AgentType {
    /// Python Nethra master agent
    PythonNethra,
    /// Rust TREDO trading engine
    RustTREDO,
...
impl std::fmt::Display for AgentType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            AgentType::PythonNethra => write!(f, "python_nethra"),
            AgentType::RustTREDO => write!(f, "rust_tredo"),
