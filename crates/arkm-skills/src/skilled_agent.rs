...
use crate::{HermesAgent, MarketAnalysisContext, AggregatedAnalysis, ProviderError, LearningFeedback};
use arkm_core::AgentProvider;

/// The default Rust-native agent provider.
///
/// Wraps `HermesAgent` and its 30+ technical/risk/portfolio skills
...
impl SkilledAgent {
    pub fn new(hermes: Arc<HermesAgent>) -> Self {
        Self { hermes }
    }
}
